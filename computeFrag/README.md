...
**Citation:
<br> Jalayer, F., Ebrahimian, H., Trevlopoulos, K., and Bradley, B. (2022).Empirical tsunami fragility modelling for hierarchical damage levels. https://doi.org/10.5194/egusphere-2022-206 [cite](https://doi.org/10.5194/egusphere-2022-206)
<br>
<br> _Please consider citing the following DOI if you directly use ComputeFrag in your work:_ https://doi.org/10.5281/zenodo.5167276 [cite](https://doi.org/10.5281/zenodo.5167276)
